  ...
  catalog: {
    frames: [
      ...
      },
      {
        ...
        basePriceRats: 350,
        defaultBarrelMm: 140,
        actionIds: ["singleAction", "doubleAction"],
        magazineIds: ["cylinder"],
        attachmentIds: ["redDot", "scope", "laser", "flashlight", "compensator", "muzzleBrake"],
        note: "Six chambers, no feed failures. The cylinder gap vents gas — suppressors do nothing here.",
      },
      {
        id: "machinePistol",
        label: "Machine Pistol",
        example: "Schnellfeuer Conversion",
        ammoClasses: ["pistol"],
        rangeMalusId: "pistol",
        baseDice: 0,
        baseWeightKg: 1.35,
        basePriceRats: 950,
        defaultBarrelMm: 140,
        actionIds: ["semi", "semiBurst", "semiBurst2", "semiFull"],
        magazineIds: ["box", "detachable", "extended", "drum"],
        attachmentIds: ["redDot", "laser", "flashlight", "suppressor", "compensator", "muzzleBrake", "foregrip"],
        note: "A gunsmith's select-fire conversion. Wild without the holster-stock fitted — burst and auto chew ammo fast.",
      },
      {
        id: "smg",
        label: "SMG",
